...
export default function Login() {
  ...
  return (
    <div className="min-h-screen flex items-center justify-center bg-gradient-to-br from-background via-accent/20 to-background p-4 relative overflow-hidden">
      ...
      <Card className="w-full max-w-md relative backdrop-blur-sm bg-card/95 border-border/50 shadow-xl">
        <CardHeader className="text-center space-y-6 pb-2">
          <div className="mx-auto w-20 h-20 bg-gradient-to-br from-primary to-primary/70 rounded-2xl flex items-center justify-center shadow-lg shadow-primary/25 rotate-3 hover:rotate-0 transition-transform duration-300">
          ...
          <div className="space-y-2">
            ...
            <div className="flex items-center justify-center gap-2 text-primary">
              ...
              <span className="text-sm font-medium">Real Estate CRM</span>
              <Sparkles className="h-4 w-4" />
            </div>
          </div>
          <CardDescription className="text-base">
            Manage your properties, leads, and sales pipeline in one powerful platform
          </CardDescription>
        </CardHeader>

...
import {
  ...
  Home, CheckCircle2, Circle, ArrowRight, UserPlus, BookUser, Edit2
} from 'lucide-react';
  ...
  return (
    <>
                    ...
                    <div className="relative">
                      <div className="flex items-center justify-between mb-2">
                        {pipelineStages.map((stage, index) => (
                          ...
                          >
                            <div
                              className={`w-6 h-6 rounded-full flex items-center justify-center border-2 transition-all ${index < currentStageIndex
                      ...
                      <div className="flex items-center justify-between mt-1">
                        {pipelineStages.map((stage, index) => (
                          <span
                            key={stage.name}
                            className={`text-[10px] flex-1 text-center ${index <= currentStageIndex
                  ...
                  <div className="space-y-4">
                    {history.map((event, index) => (
                      <div key={event.id} className="relative flex gap-4 pl-8">
                        {/* Timeline dot */}
                        <div className={`absolute left-0 top-1 w-6 h-6 rounded-full flex items-center justify-center ${event.type === 'created'
      ...
      <SaveToContactBookDialog
        ...
        contactPhone={lead && canViewPhone && showPhone ? (lead.phone || '') : ''}
